...
<Image name="bun-create-astro_2142_1418.png" />
...
<Image name="bun-run-dev_2142_1418.png" />
...
上記の`astro.config.mjs`を編集すると[http://localhost:4321](http://localhost:4321)は以下のように404になります。
 ...
 * new URL('/image_200_100.png') => '/subdirectory/image_200_100.png'
 * ```
 */
